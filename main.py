        ...
        while(True):
            ...
            if there_exists(['search wikipedia for','from wikipedia'],query):
                ...
                if 'search wikipedia for' in query:
                    ...
                    SR.speak("According to wikipedia:\n")
                    SR.speak(results)
            elif there_exists(['wikipedia','tell me about'],query):
                SR.speak("Searching wikipedia....")
            ...
            #jokes
                            ...
                            'would like to hear some jokes','tell me more jokes','tell me another joke'],query):
            ...
            #asking for name
                ...
                SR.speak("hello this is lili and I'm your personal assistant.")
            elif there_exists(["who named you","who gave you the name","who game you name"],query):
                SR.speak("My creator named me lili")
            elif there_exists(["what is the history behind your name","why your name is lili","tell us about your name",'what is behind lily'],query):
                SR.speak("actually nothing special it's named from my creator's pet")
            elif there_exists(["can i change your name","your name can be changed","will you change your name"],query):
                SR.speak("yes but you have to pay for this to my creator")
            
            #thanks
            # elif there_exists(["thank you lili","oh thanks","thanks",'thank you','nice to meet u lily'],query):
            #     SR.speak("you are welcome sir the pleasure is mine")
            #thanks
            elif there_exists(['thank you','excellent work'],query):
                conn = sqlite3.connect('main.db')
                mycursor=conn.cursor()
                mycursor.execute('select sentences from thankyou')
                result=mycursor.fetchall()
            ...
            #playing on youtube
                ...
                break
            elif there_exists(['open facebook','access facebook'," let's go to facebook"],query):
            ...
            #play music
            elif there_exists(['play music','play a song for me','play song' ,'play some music for me','like to listen some music'],query):
            ...
            #whatsapp message
                ...
                del whatsapp
            #what is meant by
            elif there_exists(['what is meant by','what is mean by','what is','who is'],query):
                results=wikipedia.summary(query,sentences=2)
                SR.speak("According to wikipedia:\n")
                SR.speak(results)
            ...
            #play game
            elif there_exists(['would like to play some games','play some games','would like to play some game','want to play some games','i wanna play games','want to play game','want to play games','play games','open games','play game','open game'],query):
            ...
            #opening software applications
            elif there_exists(['open google chrome','open crome'],query):
                SR.speak("Opening chrome")
                os.startfile(r'C:\Users\USER\AppData\Local\Google\Chrome\Application\chrome.exe')
                break
            elif there_exists(['open a browser','open browser','open an internet browser'],query):
                SR.speak("Opening browser")
                os.startfile(r'C:\Users\USER\AppData\Local\Google\Chrome\Application\chrome.exe')
                break
                ...
                break
            elif there_exists(['open powershell'],query):
                ...
                os.startfile(r'C:\Users\USER\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\WhatsApp\WhatsApp.lnk')
                break
            ...
            #password generator
            elif there_exists(['suggest me a password','give me a password','i need a password','make a password','password suggestion','i want a password'],query):
            ...
            #dating    
                ...
                SR.speak('sorry, I have a headache')
                
            #single
            elif 'are you single' in query:
                SR.speak('I am just a virtual machine i can not be in a relationship')
            ...
            elif there_exists(['exit','keep quit','quit','shutdown','shut up','thanks and goodbye','goodbye','ok shut down'],query):
                SR.speak("thank you and shutting down")
                sys.exit()
            
            #oh yeah,
            elif 'oh yeah' in query:
                SR.speak('oh yeah baby')
            ...
            elif there_exists(['search something for me','to do a little search','search mode','i want to search something','can you search'],query):
